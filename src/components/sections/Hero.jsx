...
export default function Hero() {
  ...
  return (
    <section
      id="hero"
      className="relative min-h-screen flex flex-col items-center justify-center overflow-x-hidden px-4 sm:px-6 pt-24 pb-16"
    >
      ...
      <div className="relative z-10 max-w-7xl w-full grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-12 items-center my-auto">
        ...
        <div className="lg:col-span-5 flex justify-center items-center order-1 lg:order-2">
          <motion.div
            ...
            className="transform-gpu relative w-56 h-56 sm:w-72 sm:h-72 lg:w-80 lg:h-80 mx-auto"
          >
            ...
            <div className="w-full h-full p-1 bg-gradient-to-tr from-[var(--accent)] via-[var(--accent-2)] to-cyan-400 rounded-full shadow-2xl shadow-[var(--accent-glow)]">
              ...
              <div className="w-full h-full rounded-full overflow-hidden bg-[var(--bg-card)] border-2 border-[var(--border)] relative flex items-center justify-center">
                {!imgError ? (
                  ...
                  /* Fallback Monogram Avatar if image is not present in /public yet */
                  <div className="w-full h-full bg-gradient-to-br from-[var(--bg-card)] to-[var(--bg-surface)] flex flex-col items-center justify-center p-6 text-center">
                    <span className="text-5xl lg:text-6xl font-black bg-gradient-to-r from-[var(--accent)] to-[var(--accent-2)] bg-clip-text text-transparent">
                      AF
                    </span>
